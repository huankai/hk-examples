...
//
//        param.setServicePackage("com.hk.core.emi.service");
//
//        param.setControllerPackage("com.hk.core.emi.controller");
//
//        ConnectionModel connectionModel = new ConnectionModel.MySql5Connection("jdbc:mysql://localhost:3306/hk_emi?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true", "root", "root");
