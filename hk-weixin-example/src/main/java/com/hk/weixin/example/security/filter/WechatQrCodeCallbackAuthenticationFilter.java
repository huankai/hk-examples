    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        if (StringUtils.isNotEmpty(code)) { // 用户同意授权
            try {
                ...
                UserDetails userDetails = new SecurityUserPrincipal(false, mpUser.getOpenId(), mpUser.getNickname(),
                        null, mpUser.getNickname(), ByteConstants.FIVE, null, null, mpUser.getSexId().byteValue(), mpUser.getHeadImgUrl(), ByteConstants.ONE);
