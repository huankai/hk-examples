...
/**
 * 非学业测试修改3稿\【1】小学六年级\【3】小学教师问卷
 *
 * @author huangkai
 * @date 2019-02-14 11:19
 */
@SpringBootTest(classes = {MysqlExampleApplication.class})
public class XiaoxueTeacherTest extends BaseTest {
    ...
    public void quotaTest() {
        ...
        ReadResult<ScoringRules> readResult = readableExcel.read(new File("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【1】小学六年级/【3】小学教师问卷/小学教师问卷计分规则.xlsx"));
        List<ScoringRules> data = readResult.getAllSheetData();
        String questionnaireId = "6b1b3401-8563-4093-89c8-eb38f508b5b6";
        ...
        for (ScoringRules item : data) {
            ...
            if (questionCodeMap.isPresent()) {
                ...
                arguments.getConditions().addCondition(new SimpleCondition("parent_id", "f99d2e3f-a913-42a7-b69c-4c254a1183e5"));
    ...
    @Test
    public void xiaoxueTeacher() throws IOException {
        ReadParam<ScoringRules> readParam = ReadParam.<ScoringRules>builder()
                .beanClazz(ScoringRules.class)
                .build();
        ReadableExcel<ScoringRules> readableExcel = new DomReadExcel<>(readParam);
...
//        System.exit(0);
        ...
        FileInputStream fileInputStream = new FileInputStream("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【1】小学六年级/【3】小学教师问卷/1【问卷测试题】小学教师问卷.docx");
...
//            System.out.println("text: " + text);
    ...
    private static final String QUESTIONNAIRE_ID = "6b1b3401-8563-4093-89c8-eb38f508b5b6";
