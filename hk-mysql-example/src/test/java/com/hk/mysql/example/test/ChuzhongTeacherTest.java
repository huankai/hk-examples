...
public class ChuzhongTeacherTest extends BaseTest {
    ...
    public void quotaTest() {
        ...
        String questionnaireId = "156666d4-43b0-423c-867e-7844641adfa7";
        ...
        for (ScoringRules item : data) {
            ...
            if (questionCodeMap.isPresent()) {
                ...
                arguments.getConditions().addCondition(new SimpleCondition("parent_id", "9dfc9e7b-9455-4a1a-8d66-78fe4aaf0c4b"));
