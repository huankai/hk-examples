...
/**
 * 非学业测试修改3稿\【2】初中九年级\【4】初中校长问卷
 *
 * @author huangkai
 * @date 2019-02-14 11:19
 */
@SpringBootTest(classes = {MysqlExampleApplication.class})
public class ChuzhongXiaoZhaoTest extends BaseTest {
    ...
    public void quotaTest() {
        ...
        ReadResult<ScoringRules> readResult = readableExcel.read(new File("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【2】初中九年级/【4】初中校长问卷/初中校长问卷计分规则.xlsx"));
        List<ScoringRules> data = readResult.getAllSheetData();
        String questionnaireId = "f699b61b-4b98-4216-93a2-ff6b9725b73d";
        ...
        for (ScoringRules item : data) {
            ...
            if (questionCodeMap.isPresent()) {
                ...
                arguments.getConditions().addCondition(new SimpleCondition("parent_id", "30ea0cf7-bf67-453c-96a4-7a55a5558f54"));
    ...
    @Test
    public void chuzhongXiaozhang() throws IOException {
        ReadParam<ScoringRules> readParam = ReadParam.<ScoringRules>builder()
                .beanClazz(ScoringRules.class)
                .build();
        ReadableExcel<ScoringRules> readableExcel = new DomReadExcel<>(readParam);
        ...
        FileInputStream fileInputStream = new FileInputStream("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【2】初中九年级/【4】初中校长问卷/1【问卷测试题】初中校长问卷.docx");
...
//            System.out.println("text: " + text);
    ...
    private static final String QUESTIONNAIRE_ID = "f699b61b-4b98-4216-93a2-ff6b9725b73d";
