...
/**
 * 非学业测试修改3稿\【1】小学六年级\【1】小学学生问卷
 *
 * @author huangkai
 * @date 2019-02-14 11:19
 */
@SpringBootTest(classes = {MysqlExampleApplication.class})
public class XiaoxueStudentTest extends BaseTest {
    ...
    public void quotaTest() {
        ...
        ReadResult<ScoringRules> readResult = readableExcel.read(new File("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【1】小学六年级/【1】小学学生问卷/小学学生问卷计分规则.xlsx"));
        List<ScoringRules> data = readResult.getAllSheetData();
        String questionnaireId = "7f7fe559-b5ed-4af6-8cd4-c608691d0ea6";
        ...
        for (ScoringRules item : data) {
            ...
            if (questionCodeMap.isPresent()) {
                ...
                arguments.getConditions().addCondition(new SimpleCondition("parent_id", "8bd90cbc-dbad-4681-8990-f0b9ee15e310"));
    ...
    @Test
    public void xiaoxueStudent() throws IOException {
        ReadParam<ScoringRules> readParam = ReadParam.<ScoringRules>builder()
                .beanClazz(ScoringRules.class)
                .build();
        ReadableExcel<ScoringRules> readableExcel = new DomReadExcel<>(readParam);
...
//        System.exit(-1);
        ...
        FileInputStream fileInputStream = new FileInputStream("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【1】小学六年级/【1】小学学生问卷/1【问卷测试试题】小学学生问卷.docx");
...
//            System.out.println("startWithNumber: " + StringUtils.startWithNumber(paragraph.getParagraphText()));
//            System.out.println("startWithLetter: " + StringUtils.startWithLetter(StringUtils.trimToEmpty(paragraph.getParagraphText())));
//            System.out.println("isWordWrap:" + paragraph.isWordWrap());
//            System.out.println("isWordWrapped:" + paragraph.isWordWrapped());
//            System.out.println("isPageBreak:" + paragraph.isPageBreak());
        }
...
//
    ...
    private static class QuestionnaireQuestion {
        ...
        private String questionnaireId = "7f7fe559-b5ed-4af6-8cd4-c608691d0ea6";
