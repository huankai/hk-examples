...
/**
 * 非学业测试修改3稿\【1】小学六年级\【4】小学校长问卷
 *
 * @author huangkai
 * @date 2019-02-14 11:19
 */
@SpringBootTest(classes = {MysqlExampleApplication.class})
public class XiaoxueXiaoZhaoTest extends BaseTest {
    ...
    public void quotaTest() {
        ...
        ReadResult<ScoringRules> readResult = readableExcel.read(new File("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【1】小学六年级/【4】小学校长问卷/小学校长问卷计分规则.xlsx"));
        List<ScoringRules> data = readResult.getAllSheetData();
        String questionnaireId = "83f8ca81-3513-44f6-8692-7cde4aa81238";
        ...
        for (ScoringRules item : data) {
            ...
            if (questionCodeMap.isPresent()) {
                ...
                arguments.getConditions().addCondition(new SimpleCondition("parent_id", "c8d44d4e-55eb-4501-a8fc-1132d82e9b19"));
    ...
    @Test
    public void xiaoxueXiaozhang() throws IOException {
        ReadParam<ScoringRules> readParam = ReadParam.<ScoringRules>builder()
                .beanClazz(ScoringRules.class)
                .build();
        ReadableExcel<ScoringRules> readableExcel = new DomReadExcel<>(readParam);
...
//        System.exit(0);
        ...
        FileInputStream fileInputStream = new FileInputStream("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【1】小学六年级/【4】小学校长问卷/1【问卷测试题】小学校长问卷.docx");
...
//            System.out.println("text: " + text);
    ...
    private static final String QUESTIONNAIRE_ID = "83f8ca81-3513-44f6-8692-7cde4aa81238";
