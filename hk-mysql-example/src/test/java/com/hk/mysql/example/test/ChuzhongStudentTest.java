...
/**
 * 非学业测试修改3稿\【2】初中九年级\【1】初中学生问卷
 *
 * @author huangkai
 * @date 2019-02-14 11:19
 */
@SpringBootTest(classes = {MysqlExampleApplication.class})
public class ChuzhongStudentTest extends BaseTest {
    ...
    public void quotaTest() {
        ...
        ReadResult<ScoringRules> readResult = readableExcel.read(new File("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【2】初中九年级/【1】初中学生问卷/初中学生问卷计分规则.xlsx"));
        List<ScoringRules> data = readResult.getAllSheetData();
        String questionnaireId = "f96c61fd-f1e6-4cb1-b074-0a64b702b97d";
        ...
        for (ScoringRules item : data) {
            ...
            if (questionCodeMap.isPresent()) {
                ...
                arguments.getConditions().addCondition(new SimpleCondition("parent_id", "5c6d499c-f749-4c23-8e77-58584d563b3a"));
    ...
    @Test
    public void chuzhongStudent() throws IOException {
        ReadParam<ScoringRules> readParam = ReadParam.<ScoringRules>builder()
                .beanClazz(ScoringRules.class)
                .build();
        ReadableExcel<ScoringRules> readableExcel = new DomReadExcel<>(readParam);
        ...
        FileInputStream fileInputStream = new FileInputStream("C:/Users/sjq-278/Desktop/非学业测试修改3稿/【2】初中九年级/【1】初中学生问卷/1【问卷测试题】初中学生问卷.docx");
    ...
    private static class QuestionnaireQuestion {
        ...
        private String questionnaireId = "f96c61fd-f1e6-4cb1-b074-0a64b702b97d";
