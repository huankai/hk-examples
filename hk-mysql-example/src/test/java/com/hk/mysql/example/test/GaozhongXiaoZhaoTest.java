...
public class GaozhongXiaoZhaoTest extends BaseTest {
    ...
    public void quotaTest() {
        ...
        String questionnaireId = "1d3a9553-03bf-46a8-ab52-8e3e038327c5";
        ...
        for (ScoringRules item : data) {
            ...
            if (questionCodeMap.isPresent()) {
                ...
                arguments.getConditions().addCondition(new SimpleCondition("parent_id", "79011917-8fa1-4e4b-afc3-041e32c133d0"));
