...
public class HttpClientUtils {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SimpleGetHttpExecutor executor = new SimpleGetHttpExecutor(HttpClients
                .custom()
        ...
        String result = executor.execute("http://192.168.1.28:8081/index/myBonusPoints.html?app=true", null);
