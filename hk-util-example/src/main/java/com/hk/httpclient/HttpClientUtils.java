...
public class HttpClientUtils {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String result = new SimpleGetHttpExecutor(HttpClients
                .custom()
                .setDefaultRequestConfig(AbstractHttpExecutor.DEFAULT_REQUEST_CONFIG)
                .setDefaultCookieStore(cookieStore)
                .build()).addHeaders(new BasicHeader(HttpHeaders.CONTENT_ENCODING, Consts.UTF_8.name()),
                new BasicHeader(HttpHeaders.USER_AGENT, "Android-APP")).execute("http://192.168.1.28:8081/index/myBonusPoints.html?app=true", null);
